  ...
  if (loading) {
    return (
      <div style={{ ...styles.page, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ color: 'rgba(240,240,255,0.45)', fontSize: 16 }}>Cargando avatar...</div>
      </div>
    );
  }
          ...
          <>
            <GlassCard style={{ marginBottom: 20 }}>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16, padding: '8px 0' }}>
                ...
                <div style={{ fontSize: 13, color: 'rgba(240,240,255,0.45)', textAlign: 'center' }}>
            ...
            {avatar?.equippedItems?.length === 0 ? (
              <div style={{ color: 'rgba(240,240,255,0.45)', fontSize: 14, textAlign: 'center', padding: 20 }}>
            ...
            {shopLoading ? (
              ...
              <div style={styles.shopGrid}>
                ...
                {filteredItems.length === 0 && (
                  <div style={{ gridColumn: '1/-1', textAlign: 'center', color: 'rgba(240,240,255,0.45)', padding: 40 }}>

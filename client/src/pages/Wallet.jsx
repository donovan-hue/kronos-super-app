          ...
          <>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20, padding: '12px', background: 'rgba(255,255,255,0.04)', borderRadius: 12 }}>
              ...
              <div>
                ...
                <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: 12 }}>@{selected.username}</div>
              </div>
              <button onClick={() => { setSelected(null); setStep('search'); }} style={{ marginLeft: 'auto', background: 'none', border: 'none', color: 'rgba(255,255,255,0.4)', cursor: 'pointer', fontSize: 13 }}>Cambiar</button>
            </div>

            {/* Amount input */}
            <div style={{ textAlign: 'center', marginBottom: 20 }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 4 }}>
                <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: 28, fontWeight: 300 }}>$</span>
                <input
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 999, background: 'rgba(0,0,0,0.8)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
      <GlassCard style={{ width: '100%', maxWidth: 480, borderRadius: '20px 20px 0 0', paddingBottom: 32 }}>
        ...
        <div style={{ color: 'rgba(255,255,255,0.35)', fontSize: 11, textAlign: 'center', marginBottom: 16 }}>Demo: el dinero se añade sin cobro real</div>
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#08080f', paddingBottom: 100 }}>
      ...
      <div style={{ maxWidth: 480, margin: '0 auto', padding: '16px' }}>
        ...
        {loading ? (
          <div style={{ textAlign: 'center', color: 'rgba(255,255,255,0.4)', padding: 60 }}>Cargando wallet...</div>
        ) : (
          <>
            {/* Balance principal */}
            <GlassCard style={{ textAlign: 'center', marginBottom: 20, padding: '32px 24px', background: 'linear-gradient(135deg,rgba(124,58,237,0.15),rgba(6,182,212,0.08))' }}>
              ...
              {data?.kro && (
                <div style={{ marginTop: 16, padding: '10px 20px', background: 'rgba(168,85,247,0.15)', borderRadius: 12, display: 'inline-block' }}>
                  ...
                  <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: 12 }}> tokens</span>
                </div>
              )}
            </GlassCard>
            ...
            {tab === 'wallet' && (
              <div>
                <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: 11, marginBottom: 10, textTransform: 'uppercase', letterSpacing: 1 }}>Movimientos recientes</div>
            ...
            {tab === 'card' && (
              <div>
                ...
                <GlassCard>
                  <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: 12, marginBottom: 12 }}>Detalles de la tarjeta</div>
                  {[
                    ...
                    <GlassCard style={{ marginBottom: 12 }}>
                      {[
                        ...
                        <div key={item.label} style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 0', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                          <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: 14 }}>{item.label}</span>

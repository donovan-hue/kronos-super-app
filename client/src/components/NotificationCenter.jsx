...
export default function NotificationCenter() {
  ...
  return (
    <div className="relative">
      ...
      >
        <svg className="w-5 h-5" style={{ color: 'rgba(201,206,212,0.55)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {open && (
        <>
          ...
          <div style={{ position: 'absolute', right: 0, top: 40, zIndex: 50, width: 320, maxHeight: 384, overflowY: 'auto', borderRadius: 20, border: '1.5px solid rgba(190,200,212,0.15)', background: 'rgba(255,255,255,0.98)', backdropFilter: 'blur(20px)', boxShadow: '0 8px 40px rgba(190,200,212,0.14)' }}>
            ...
            {notifications.length === 0 ? (
              <div style={{ padding: '48px 0', textAlign: 'center', color: 'rgba(201,206,212,0.35)', fontSize: 14 }}>Sin notificaciones</div>
            ) : (
              notifications.map(n => (
                <button
                  key={n._id}
                ...
                >
                  ...
                  <p style={{ fontSize: 10, color: 'rgba(201,206,212,0.35)', marginTop: 4, marginBottom: 0 }}>
